...
export const homeHero = {
  ...
  description:
    "Vedixa Technologies is your partner for digital transformation. We deliver software development, web and mobile apps, enterprise systems, AI automation, cloud solutions and architectural design services—all under one roof.",
...
export const integratedProcess = [
  "Concept & Planning",
...
export const homeCTA = {
  ...
  description:
    "Let's build powerful software, intelligent solutions and inspiring spaces together.",
